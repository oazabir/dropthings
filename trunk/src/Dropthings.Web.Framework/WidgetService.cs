...
namespace Dropthings.Web.Framework
{
    ...
    public class WidgetService : WebServiceBase
    {
        ...
        {
            AspectF.Define
                .Log(Logger.Writer, "AddWidgetInstance {0} {1} {2}", widgetId, toZone, toRow)
        ...
        {
            AspectF.Define
                .Log(Logger.Writer, "AssignPermission {0}", widgetPermissions)
        ...
        {
            AspectF.Define.Log(Logger.Writer, "ChangePageLayout {0}", newLayout).Do(() =>
            {
                using (var facade = new Facade(new AppContext(string.Empty, Profile.UserName)))
                {
        ...
        {
            AspectF.Define.Log(Logger.Writer, "ChangeWidgetTitle {0} {1}", widgetId, newTitle)
        ...
        {
            return AspectF.Define.Log(Logger.Writer, "CollaspeWidgetInstance {0} {1}", widgetId, postbackUrl)
                .MustBeNonDefault<int>(widgetId)
        ...
        {
            AspectF.Define.Log(Logger.Writer, "DeleteWidgetInstance {0}", widgetId)
                .MustBeNonDefault<int>(widgetId)
                .Do(() =>
                {
                    using (var facade = new Facade(new AppContext(string.Empty, Profile.UserName)))
        ...
        {
            return AspectF.Define.Log(Logger.Writer, "ExpandWidgetInstance {0} {1}", widgetId, postbackUrl)
                .MustBeNonDefault<int>(widgetId)
                .Return<string>(() =>
                {
                    using (var facade = new Facade(new AppContext(string.Empty, Profile.UserName)))
        ...
        {
            return AspectF.Define.Log(Logger.Writer, "GetWidgetState {0}", widgetId)
                .MustBeNonDefault<int>(widgetId)
                .Return<string>(() =>
                {
                    using (var facade = new Facade(new AppContext(string.Empty, Profile.UserName)))
        ...
        {
            AspectF.Define.Log(Logger.Writer, "DeleteWidgetInstance {0}", instanceId)
        ...
        {
            AspectF.Define.Log(Logger.Writer, "ResizeWidgetInstance {0} {1} {2}", widgetId, width, height)
        ...
        {
            AspectF.Define.Log(Logger.Writer, "ResizeWidgetInstance {0}", widgetId)
                .MustBeNonDefault<int>(widgetId)
                .Do(() =>
                {
                    using (var facade = new Facade(new AppContext(string.Empty, Profile.UserName)))
        ...
        {
            AspectF.Define.Log(Logger.Writer, "SaveWidgetState {0} {1}", widgetId, state)
