<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MemberManagerWidget.ascx.cs" Inherits="Widgets_MemberManagerWidget" %>
<asp:ObjectDataSource ID="odsMembers" runat="server" EnablePaging="True" 
    SelectCountMethod="GetMemberCount" 
    SelectMethod="GetPagedMember"
    TypeName="Dropthings.Business.Facade.Facade" SortParameterName="sortExpression">
            ...
            <asp:ListView ID="lvItems" DataSourceID="odsMembers" runat="server" OnItemCommand="ItemCommand">
                <LayoutTemplate>                                         
                    <table id="MemberList" runat="server" class="datatable" cellpadding="0" cellspacing="0">
                        <tr>
                            <th class="first">
                                <asp:LinkButton ID="btnSortByUserName" Text="UserName" CommandName="Sort" CommandArgument="Username" runat="server" />
                            </th>
                            <th>IsActive</th>
                            <th></th>
                        </tr>
