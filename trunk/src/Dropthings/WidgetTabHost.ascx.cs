...
public partial class WidgetTabHost : System.Web.UI.UserControl
{
    ...
    public void LoadWidgets(Tab tab, string widgetContainerPath)
    {
        this.CurrentTab = tab;
    ...
    private void SetupWidgetZones(string widgetContainerPath)
    {
        ...
        {
            columns = facade.GetColumnsInTab(CurrentTab.ID);
        }
        ...
        columns.Each<Column>( (column, index) =>
        {
            ...
            if (widgetZone != null)
            {
                ...
                widgetZone.IsLocked = this.CurrentTab.IsLocked && !this.CurrentTab.IsDownForMaintenance;
            }
